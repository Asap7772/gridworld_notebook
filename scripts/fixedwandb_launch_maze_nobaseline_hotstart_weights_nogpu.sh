...
PREFIX=exp
PROJ_NAME=algo_gridworlds_hotstartweights
COUNTER=0
    ...
    do
        ...
        do
            ...
            do
                ...
                python /home/asap7772/asap7772/algo_gridworld/offline_rl_gridworld_fixedwandb.py --maze_type=$i --env_type=$ENV_TYPE --dataset_composition=$l --cql_alpha_val=$j --transform_type=$DES_TYPE --const_transform=$k --exp_start=$PREFIX --proj_name=$PROJ_NAME --hotstart_weight --nogpu &
                let COUNTER++
            done
        done
        wait
